This is a CLI program that displays the largest files and directories on your file system. This was written in Golang in an effort to better learn Golang.
## Usage
Usage example:
```bash
